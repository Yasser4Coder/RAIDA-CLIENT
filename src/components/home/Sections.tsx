...
import {
  stats, communityCards, members, brands, serviceCategories,
  events, successStories, partners, pricingPlans,
} from '../../data/mockData'
...
export function EventsSection() {
  ...
  return (
    <section className="py-16 lg:py-24 bg-ivory relative">
      {/* Soft material wash — no competing busy background */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {/* Featured — larger surface, thicker material feel */}
          <Reveal>
...
export function FinalCTA() {
  ...
  return (
    <section className="relative isolate overflow-hidden min-h-[28rem] sm:min-h-[32rem] flex items-center">
      ...
      {/* Depth overlays — contrast without killing the photo */}
      ...
      <div className="relative w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-28 text-center">
        <Reveal>
          {/* Announcement / brand chip — material */}
          ...
          <div className="mt-6 flex items-center justify-center gap-3">
            ...
            <p className="text-sm text-white/70">
              <span className="font-semibold text-white">+12,500</span> رائدة انضمّت بالفعل
            </p>
          </div>
        </Reveal>
      </div>
