...
export const routeSeo = {
  ...
  experts: {
    title: `خبراء رائدة | ${SITE_NAME}`,
    description: 'دليل الخبراء والمدربين والمستشارين في رائدة — تواصل واطلب استشارة أو برنامجًا تدريبيًا.',
    path: '/experts',
    keywords: ['خبراء', 'مدربون', 'استشارات', 'RAIDA'],
  },
  programs: {
